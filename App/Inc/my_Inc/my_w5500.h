...
#define SS_SELECT() HAL_GPIO_WritePin(SPI1_CS_GPIO_Port, SPI1_CS_Pin, GPIO_PIN_RESET)
#define SS_DESELECT() HAL_GPIO_WritePin(SPI1_CS_GPIO_Port, SPI1_CS_Pin, GPIO_PIN_SET)
//--------------------------------------------------
...
#define Sn_PORT1 0x0005 // Socket 1 Source Port Register LSB
//--------------------------------------------------
